...
osMessageQueueId_t payloadStatueQueueHandle;
const osMessageQueueAttr_t payloadStatueQueue_attributes = {
  .name = "payloadStatueQueue"
};
...
uint8_t  temp_buf[10000];
uint8_t  payload_content[10000];
/**
