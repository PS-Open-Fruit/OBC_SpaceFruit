...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PF15     ------> I2C4_SDA
    */
    GPIO_InitStruct.Pin = INT_SCL_Pin|INT_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C4)
  {
    ...
    PF15     ------> I2C4_SDA
    */
    HAL_GPIO_DeInit(INT_SCL_GPIO_Port, INT_SCL_Pin);

    HAL_GPIO_DeInit(INT_SDA_GPIO_Port, INT_SDA_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PD4     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = NOR_SCK_Pin|NOR_MISO_Pin|NOR_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PG4     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOG, SD_SCK_Pin|SD_MISO_Pin|SD_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PD4     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOD, NOR_SCK_Pin|NOR_MISO_Pin|NOR_MOSI_Pin);
